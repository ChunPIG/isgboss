...
LOCAL_DIR=/data/msplogs/virus
REMOTE_DIR=/export/home/east/cdr

SHELL_HOME=/opt/isg/boss/shell

LOG_HOME=$SHELL_HOME/shell-logs
FTP_LOG=$LOG_HOME/ftp48V.log
...
do
   ...
   TRANSFER_LOG=$LOG_HOME/'ftp48V-'$(date -d  today +%Y%m%d).log
...
then
  ...
  RUN_LOG=$LOG_HOME/ftp48V.$timestamp.log
